...
public class SequenceDAO extends AbstractDAO {
    ...
    public static final String SEQ_TRAMITES = "TRAMITES";
    public static final String SEQ_PAGO_TRAMITES = "PAGO_TRAMITES";
    public static final String SEQ_CONCEPTOS_PAGO = "CONCEPTOS_PAGO";
    public static final String SEQ_PAGOS = "PAGOS";
